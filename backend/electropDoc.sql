...
CREATE TABLE `customer` (
  ...
  `middle_name` varchar(18) COLLATE utf8_unicode_ci DEFAULT '',
...
CREATE TABLE `order` (
  ...
  `payment_method` int(4) DEFAULT NULL,
  `shipping_address` varchar(32) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=143460 DEFAULT CHARSET=utf8;

/*Data for the table `order` */

insert  into `order`(`order_number`,`order_date`,`amount_stickers`,`total_price`,`order_status`,`customer_id`,`shipper_company_name`,`tracking_number`,`payment_method`,`shipping_address`) values 
(143438,1492733047,2,12.94,2,19,'UPS',4733,NULL,NULL),
(143439,1492810521,1,10.00,1,21,'UPS',5516,NULL,NULL),
(143440,1492812312,2,16.00,1,21,'UPS',5858,NULL,NULL),
(143441,1492812328,2,12.56,1,21,'UPS',3617,NULL,NULL),
(143442,1492812371,2,15.05,1,21,'UPS',2813,NULL,NULL),
(143443,1492812439,1,2.53,1,21,'UPS',7344,NULL,NULL),
(143444,1492812485,1,6.00,1,21,'UPS',1141,NULL,NULL),
(143453,1495392214,5,12.80,1,21,'UPS',4921,3344,'Barrio Loiza '),
...
(143458,1495463323,1,10.00,1,19,'UPS',5770,1234,'Example Name'),
(143459,1495464761,1,2.56,1,19,'UPS',1706,4352,'Example Street');
...
CREATE TABLE `payment_method` (
  ...
  PRIMARY KEY (`customer_id`,`card_last_digits`,`exp_date`,`card_type`),
  KEY `customer_id` (`customer_id`),
...
/*Table structure for table `payment_method_old` */
...
/*Data for the table `payment_method_old` */

insert  into `payment_method_old`(`customer_id`,`card_last_digits`,`exp_date`,`card_type`) values 
(14,'1111','20/20','Visa'),
(19,'1234','12/12','Visa'),
...
CREATE TABLE `shipping_address` (
  ...
  PRIMARY KEY (`customer_id`,`street_name`,`apt_number`,`zipcode`,`state`),
...
(19,'Example Street',321,'00669','PR'),
(20,'wewg',234324,'00669','IL'),
(21,'Barrio Loiza ',123,'00124','AL'),
(21,'Calle Ramoncillo Delgado',123,'00678','AK'),
(22,'La esquinita Famosa',69,'00234','AR'),
(23,'Uno dos',12,'12121','AK'),
(24,'jejejeje',123,'12345','PR'),
(25,'prrrraaaa',23,'99883','AL');

/*Table structure for table `shipping_address_old` */
...
/*Data for the table `shipping_address_old` */

insert  into `shipping_address_old`(`customer_id`,`street_name`,`apt_number`,`zipcode`,`state`) values 
(19,'Example Name',123,'00669','PR'),
(20,'wewg',234324,'00669','IL'),
