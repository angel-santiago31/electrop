   ...
   <?= GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'format' => 'html',
            'value' => function ($cards) {
                return Html::a('<i class="glyphicon glyphicon-pencil"></i> Remove', ['delete-card', 'id' => $cards->customer_id, 'numbers' => $cards->card_last_digits], ['class' => 'btn btn-xs btn-danger redCss', 'id' => 'updatePayment']);
            }
        ],
    ],
]) ?>
